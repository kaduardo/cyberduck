...
/**
 * @version $Id: QLPreviewPanel.java 5847 2010-03-11 06:51:31Z dkocher $
 ...
 * @discussion Every application only has on instance of QLPreviewPanel. You can not subclass QLPreviewPanel.<br>
...
public abstract class QLPreviewPanel extends NSPanel {
     ...
     * @discussion The Preview Panel automatically updates its controller (by searching the responder chain) whenever the main or key window changes. Invoke updateController if the responder chain changes without explicit notice.<br>
